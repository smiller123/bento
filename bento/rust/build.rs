...
const INCLUDED_TYPES: &[&str] = &[
    ...
    "enoki_queue",
    "enoki_sched_type",
    "enoki_msg_payload_task_wakeup",
    "enoki_msg_payload_task_new",
    "enoki_msg_payload_task_blocked",
    "enoki_msg_payload_task_preempt",
    "enoki_msg_payload_pnt",
    "enoki_msg_payload_pnt_err",
    "enoki_msg_payload_balance_err",
    "enoki_msg_payload_task_dead",
    "enoki_msg_payload_task_yield",
    "enoki_msg_payload_task_departed",
    "enoki_msg_payload_task_switchto",
    "enoki_msg_payload_task_affinity_changed",
    "enoki_msg_payload_task_prio_changed",
    "enoki_msg_payload_task_latched",
    "enoki_msg_payload_cpu_tick",
    "enoki_msg_payload_timer",
    "enoki_msg_payload_cpu_not_idle",
    "enoki_msg_payload_select_task_rq",
    "enoki_msg_payload_migrate_task_rq",
    "enoki_msg_payload_balance",
    "enoki_msg_payload_rereg_prep",
    "enoki_msg_payload_rereg_init",
    "enoki_msg_payload_msg_size",
    "enoki_msg_payload_create_queue",
    "enoki_msg_payload_enter_queue",
    "enoki_msg_payload_unreg_queue",
    "enoki_msg_payload_send_hint",
];
const INCLUDED_FUNCTIONS: &[&str] = &[
    ...
    "vfs_ioctl",
    "clone_private_mount",
    "register_enoki_sched",
    "reregister_enoki_sched",
    "unregister_enoki_sched",
    "ghost_run_pid_on",
    "printk_deferred",
    "file_write_deferred",
    "hrtick_start_cpu",
